...
addTime = Label(clock,text = "Hour  Min   Sec",font=90).place (x = 110)
setYourAlarm = Label(clock,text = "When to wake you up",fg="blue",relief = "solid",font=("Times New Roman",7,"bold")).place(x=0, y=29)
...
submit = Button(clock,text = "Set Alarm",fg="red",width = 30,command = actual_time).place(x =110,y=70)
